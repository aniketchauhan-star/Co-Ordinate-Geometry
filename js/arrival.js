/* ===================================================================
   CO-ORDINATE GEOMETRY — THE ARRIVAL  (played on START)
   -------------------------------------------------------------------
   THE SECOND OF TWO CINEMATICS. js/intro.js is the first: the aircraft
   climbing into frame while the world materialises around it, before
   the introduction screen. This one runs when the learner presses
   START, and carries them into the first mission.
